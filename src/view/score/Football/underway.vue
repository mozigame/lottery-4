    ...
    <div style="position: relative;padding:0.26rem 0 0 0;border-radius: 5px;">
      ...
      <div @click="$emit('go',propsData.third_party_schedule_id)" class="row" style="margin: 0.34rem 0 0 0;">
        ...
        <div class="text-center module4" style="position: relative;height: 1.76rem;width: 38.2%;">
          <!--进行中-->
          <div class="item">
            <div class="body">{{propsData.home_info.shots_on_goal}}/{{propsData.home_info.shoot}}</div>
            <div class="body">{{propsData.home_info.ball_possession}}</div>
          </div>
          <div class="item">
            <div class="body">{{propsData.guest_info.shots_on_goal}}/{{propsData.guest_info.shoot}}</div>
